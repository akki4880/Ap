<nav x-data="{ notificationOpen: false, open: false }" class="bg-white border-b border-gray-100 fixed w-full">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('household.index')" :active="request()->routeIs('index')">
                        {{ __('Manage Household') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('documents.index')" :active="request()->routeIs('index')">
                        {{ __('Manage Documents') }}
                    </x-nav-link>
                </div>
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('household.index')" :active="request()->routeIs('dashboard')">
                {{ __('Manage Household') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('documents.index')" :active="request()->routeIs('dashboard')">
                {{ __('Manage documents') }}
            </x-responsive-nav-link>
        </div>
